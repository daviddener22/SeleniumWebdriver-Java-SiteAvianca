...
public class InformacoesAviancaEn {
    ...
    @Test
    public void testVerificarIdiomaEn() {

       //Seleciona o idioma no RadioButton
        navegador.findElement(By.xpath("//label[@for='en_US']")).click();
       ...
       //Identifica o texto no menu superior no idioma selecionado
        WebElement TextoMenuSuperior = navegador.findElement(By.linkText("Your Trip"));

       //Verifica se o linktext "Your Trip" está disponível, caso ainda não esteja, aguarda 10 seg. até ficar disponível para o click
       ...
       //Atribuindo o valor de TextoMenuSuperior para textoMenu para ser validado
        ...
        //Valida se o texto do textlink do menu superior é "Your Trip"
         assertEquals("Your Trip", textoMenu);
    }
