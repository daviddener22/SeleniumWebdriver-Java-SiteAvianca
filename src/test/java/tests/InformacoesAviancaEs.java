...
public class InformacoesAviancaEs {
    ...
    @Test
    public void testVerificarIdiomaEs() {

        //Seleciona o idioma no RadioButton
        navegador.findElement(By.xpath("//label[@for='es_ES']")).click();
        ...
        WebElement TextoMenuSuperior = navegador.findElement(By.linkText("Su Viaje"));

        //Verifica se o linktext "Su Viaje" está disponível, caso ainda não esteja, aguarda 10 seg. até ficar disponível para o click
        ...
        //Valida se o texto do textlink do menu superior é "Su Viaje"
        assertEquals("Su Viaje", textoMenu);
    }
